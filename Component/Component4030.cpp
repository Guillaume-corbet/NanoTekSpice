...
Component4030::Component4030(std::string name):AComponent::AComponent(name)
{
...
nts::Tristate Component4030::compute(size_t pin)
{
    size_t nb = 0;
    nts::Tristate a;
    nts::Tristate b;
    ...
    if ((a == nts::TRUE && b == nts::FALSE) || (a == nts::FALSE && b == nts::TRUE))
        result = nts::TRUE;
    else
        result = nts::FALSE;
...
{
    size_t i = 0;
    std::cout << "Component4030" << std::endl;
